...
class Application extends BaseApplication
{
    ...
    public function __construct(KernelInterface $kernel)
    {
        ...
        $kernel->boot();
        if ($kernel->getContainer()->getParameter('effiana_job_queue.statistics')) {
            $this->insertStatStmt = "INSERT INTO effiana_job_statistics (job_id, characteristic, createdAt, charValue) VALUES (:jobId, :name, :createdAt, :value)";
    ...
    private function saveDebugInformation(\Exception $ex = null)
    {
        ...
        $this->getConnection()->executeUpdate(
            "UPDATE effiana_job SET stackTrace = :trace, memoryUsage = :memoryUsage, memoryUsageReal = :memoryUsageReal WHERE id = :id",
            array(
                'id' => $jobId,
    ...
    {
        return $this->getKernel()->getContainer()->get('doctrine')->getManagerForClass('EffianaJobQueueBundle:Job')->getConnection();
    }
}
