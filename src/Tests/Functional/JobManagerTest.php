...
use Effiana\JobQueueBundle\Tests\Functional\TestBundle\Entity\Train;
use Effiana\JobQueueBundle\Tests\Functional\TestBundle\Entity\Wagon;
...
class JobManagerTest extends BaseTestCase
{
    ...
    public function testCloseJobDoesNotCreateMoreThanAllowedRetries()
    {
        ...
        $this->em->clear();
        $reloadedA = $this->em->find('EffianaJobQueueBundle:Job', $a->getId());
    ...
    public function testModifyingRelatedEntity()
    {
        ...
        $reloadedJ = $this->em->find('EffianaJobQueueBundle:Job', $j->getId());

        $reloadedWagon = $reloadedJ->findRelatedEntity('Effiana\JobQueueBundle\Tests\Functional\TestBundle\Entity\Wagon');
