...
class JobQueueExtension extends \Twig_Extension
{
    ...
    {
        return array(
            new \Twig_SimpleTest('effiana_job_queue_linkable', array($this, 'isLinkable'))
        );
    }
    ...
    {
        return array(
            new \Twig_SimpleFunction('effiana_job_queue_path', array($this, 'generatePath'), array('is_safe' => array('html' => true)))
        );
    }
    ...
    {
        return array(
            new \Twig_SimpleFilter('effiana_job_queue_linkname', array($this, 'getLinkname')),
            new \Twig_SimpleFilter('effiana_job_queue_args', array($this, 'formatArgs'))
        );
    }
