...
class JobQueueExtension extends AbstractExtension
{
    ...
    {
        return array(
            new TwigTest('effiana_job_queue_linkable', array($this, 'isLinkable'))
        );
    }
    ...
    {
        return array(
            new TwigFunction('effiana_job_queue_path', array($this, 'generatePath'), array('is_safe' => array('html' => true)))
        );
    }
    ...
    {
        return array(
            new TwigFilter('effiana_job_queue_linkname', array($this, 'getLinkname')),
            new TwigFilter('effiana_job_queue_args', array($this, 'formatArgs'))
        );
    }
