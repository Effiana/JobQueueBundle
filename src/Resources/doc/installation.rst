...
Installing EffianaJobQueueBundle
============================

You can easily install EffianaJobQueueBundle with composer. Just add the following
...
Finally, have your ``app/console`` use EffianaJobQueueBundle's ``Application``:
...
.. code-block :: yaml
    ...
    EffianaJobQueueBundle:
        resource: "@EffianaJobQueueBundle/Controller/"
        type: annotation
        prefix: /jobs
...
.. code-block :: yaml
    ...
    jms_security_extra:
        method_access_control:
            "EffianaJobQueueBundle:.*:.*": "hasRole('ROLE_ADMIN')"
...
.. code-block :: ini
    ...
    stdout_logfile=%capistrano.shared_dir%/effiana_job_queue_runner.out.log
    stdout_capture_maxbytes=1MB
    stderr_logfile=%capistrano.shared_dir%/effiana_job_queue_runner.error.log
